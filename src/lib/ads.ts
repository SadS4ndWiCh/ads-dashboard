...
const allHoraries = [
  {
    ...
    label: 'Segunda',
    classesSchedules: [
      { startTime: '7:40', classSubjectName: 'Linguagem de Programação' },
      { startTime: '8:30', classSubjectName: 'Linguagem de Programação' },
      { startTime: '9:30', classSubjectName: 'Linguagem de Programação' },
      { startTime: '10:20', classSubjectName: 'Linguagem de Programação' },
      { startTime: '11:10', classSubjectName: 'Engenharia de Software' },
      { startTime: '12:00', classSubjectName: 'Engenharia de Software' },
    ]
  },
  {
    weekday: 2,
    ...
    classesSchedules: [
      ...
      { startTime: '8:30', classSubjectName: 'Sem aula' },
      { startTime: '9:30', classSubjectName: 'Comunicação e Expressão' },
      { startTime: '10:20', classSubjectName: 'Comunicação e Expressão' },
      { startTime: '11:10', classSubjectName: 'Cálculo' },
      { startTime: '12:00', classSubjectName: 'Cálculo' },
    ],
  },
  {
    weekday: 3,
    label: 'Quarta',
    classesSchedules: [
      { startTime: '7:40', classSubjectName: 'Comunicação e Expressão' },
      { startTime: '8:30', classSubjectName: 'Comunicação e Expressão' },
      { startTime: '9:30', classSubjectName: 'Contabilidade' },
      { startTime: '10:20', classSubjectName: 'Contabilidade' },
      { startTime: '11:10', classSubjectName: 'Engenharia de Software' },
      { startTime: '12:00', classSubjectName: 'Engenharia de Software' },
    ],
  },
  {
    ...
    classesSchedules: [
      { startTime: '7:40', classSubjectName: 'Sem aula' },
      { startTime: '8:30', classSubjectName: 'Sem aula' },
      { startTime: '9:30', classSubjectName: 'Cálculo' },
      { startTime: '10:20', classSubjectName: 'Cálculo' },
      { startTime: '11:10', classSubjectName: 'Sistemas de Informação' },
      { startTime: '12:00', classSubjectName: 'Sistemas de Informação' },
    ],
  },
  {
    weekday: 5,
    ...
    classesSchedules: [
      { startTime: '7:40', classSubjectName: 'Sem aula' },
      { startTime: '8:30', classSubjectName: 'Sem aula' },
      { startTime: '9:30', classSubjectName: 'Sistema de Informação' },
      { startTime: '10:20', classSubjectName: 'Sistema de Informação' },
      { startTime: '11:10', classSubjectName: 'Inglês' },
      { startTime: '12:00', classSubjectName: 'Inglês' },
    ],
  },
];
